        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-700 rounded-2xl p-8 shadow-2xl">
            <div className="space-y-6">
              ...
              <button
                onClick={handleJoin}
                className="w-full py-4 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg hover:from-red-500 hover:to-red-600 transition-all duration-200 font-bold text-lg shadow-lg transform hover:scale-105 flex items-center justify-center space-x-2"
              >
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                <div className="text-center">
                  <div className="bg-green-600 p-3 rounded-full mx-auto mb-2 w-12 h-12 flex items-center justify-center">
                ...
                <div className="text-center">
                  <div className="bg-blue-600 p-3 rounded-full mx-auto mb-2 w-12 h-12 flex items-center justify-center">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"/>
                    </svg>
                  </div>
                  <p className="text-xs text-gray-400">Clear Audio</p>
                </div>
                <div className="text-center">
                  <div className="bg-purple-600 p-3 rounded-full mx-auto mb-2 w-12 h-12 flex items-center justify-center">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
